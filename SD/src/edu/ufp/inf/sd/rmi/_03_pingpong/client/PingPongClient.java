...
public class PingPongClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            ...
            PingPongClient hwc=new PingPongClient(args);
            //2. ============ Lookup service ============
            hwc.lookupService();
            //3. ============ Play with service ============
            hwc.playService();
    ...
    private void playService() {
        try {
            ...
            PongImpl pong = new PongImpl(pingRI, ball);

            pong.pong(ball);

            Remote exportObj = java.rmi.server.UnicastRemoteObject.exportObject(pingRI, 0);

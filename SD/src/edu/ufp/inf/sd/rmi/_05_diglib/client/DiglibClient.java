package edu.ufp.inf.sd.rmi._05_diglib.client;

import edu.ufp.inf.sd.rmi._05_diglib.server.DiglibFactorydRI;
...
public class DiglibClient {
     ...
     */
    private DiglibFactorydRI helloWorldRI;
    ...
    private Remote lookupService() {
        try {
            ...
            if (registry != null) {
                ...
                helloWorldRI = (DiglibFactorydRI) registry.lookup(serviceUrl);
            } else {

...
@set JAVAPROJ=C:/Users/manue/Desktop/GitHub/3UFP_2SEM/SD
@Set PACKAGE=_02_calculator
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=CalculatorService
@Set CLIENT_CLASS_PREFIX=Calculator
@Set SERVER_CLASS_PREFIX=Calculator
